package com.alvaroperez.api.Forohub.controller.response;

import com.alvaroperez.api.Forohub.domain.response.DTO.ResponseDataList;
import com.alvaroperez.api.Forohub.domain.response.DTO.ResponseDataResponse;
import com.alvaroperez.api.Forohub.domain.response.DTO.ResponseDataUpdate;
import com.alvaroperez.api.Forohub.domain.response.DTO.ResponseRegistrationData;
import com.alvaroperez.api.Forohub.domain.response.Response;
import com.alvaroperez.api.Forohub.domain.response.ResponseRepository;
